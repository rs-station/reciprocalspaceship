...
plt.figure()
plt.plot(I / SigI, 100.0 * (rs_F - F) / F, "k.", alpha=0.1, label="Acentric")
plt.plot(
    (I / SigI)[Centric],
    (100.0 * (rs_F - F) / F)[Centric],
    "r.",
    alpha=0.1,
    label="Centric",
)
...
plt.figure()
plt.plot(I / SigI, 100.0 * (rs_J - J) / J, "k.", alpha=0.1, label="Acentric")
plt.plot(
    (I / SigI)[Centric],
    (100.0 * (rs_J - J) / J)[Centric],
    "r.",
    alpha=0.1,
    label="Centric",
)
...
plt.figure()
plt.hist(
    (100.0 * (rs_J - J) / J)[~Centric], 100, color="k", label="Acentric", alpha=0.4
)
plt.hist((100.0 * (rs_J - J) / J)[Centric], 100, color="r", label="Centric", alpha=0.4)
plt.legend()
...
plt.figure()
plt.hist(
    (100.0 * (rs_F - F) / F)[~Centric], 100, color="k", label="Acentric", alpha=0.4
)
plt.hist((100.0 * (rs_F - F) / F)[Centric], 100, color="r", label="Centric", alpha=0.4)
plt.legend()
...
plt.figure()
plt.hist(
    (100.0 * (rs_SigF - SigF) / SigF)[~Centric],
    100,
    color="k",
    label="Acentric",
    alpha=0.4,
...
plt.figure()
plt.hist(
    (100.0 * (rs_SigJ - SigJ) / SigJ)[~Centric],
    100,
    color="k",
    label="Acentric",
    alpha=0.4,
