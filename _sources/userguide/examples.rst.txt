...
.. note::
   ...
   interactively on `binder <https://mybinder.org/v2/gh/rs-station/reciprocalspaceship/main?filepath=docs%2Fexamples>`_
   or by downloading the notebook files from the
   `Examples Directory <https://github.com/rs-station/reciprocalspaceship/tree/main/docs/examples>`_
